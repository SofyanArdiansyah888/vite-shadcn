...
import PenggajianTable from "@/pages/penggajian/(penggajian)/_components/penggajian-table.tsx";
import PenggajianModal from "@/pages/penggajian/(penggajian)/_components/penggajian-modal.tsx";
import {createFileRoute} from "@tanstack/react-router";

export const Route = createFileRoute('/penggajian/(penggajian)/')({
    component: () => <Index />
})
