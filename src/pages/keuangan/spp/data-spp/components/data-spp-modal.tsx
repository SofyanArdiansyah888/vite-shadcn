...
import DataSppEntity from "@/pages/keuangan/spp/data-spp/data/data-spp.entity.ts";
...
export default function DataSppModal({isOpen, handleGroupModal, selectedData, setSelectedData}: IKelasModal) {
