...
import LiburEntity from "@/pages/akademik/referensi/mata-pelajaran/_data/mata-pelajaran.entity.ts";
...
export default function KategoriPengeluaranModal({isOpen, handleGroupModal, selectedData, setSelectedData}: IKelasModal) {
