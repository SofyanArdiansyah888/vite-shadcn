...
import InformasiEntity from "@/pages/modul/informasi/data/informasi.entity.ts";
import InformasiModal from "@/pages/modul/informasi/components/informasi-modal.tsx";
import InformasiTable from "@/pages/modul/informasi/components/informasi-table.tsx";
