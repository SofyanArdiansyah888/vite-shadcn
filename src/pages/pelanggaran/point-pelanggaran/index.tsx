...
import PoinPelanggaranTable from "@/pages/pelanggaran/point-pelanggaran/_components/poin-pelanggaran-table.tsx";
import GroupBadgeFilter from "@/components/shared/group-badge-filter.tsx";
import PoinPelanggaranFilter from "@/pages/pelanggaran/point-pelanggaran/_components/poin-pelanggaran-filter.tsx";
import usePoinPelanggaranStore from "@/pages/pelanggaran/point-pelanggaran/_data/usePoinPelanggaranStore.ts";
import {createFileRoute} from "@tanstack/react-router";

export const Route = createFileRoute('/pelanggaran/point-pelanggaran/')({
    component: () => <Index/>
})
