...
import Index from "@/pages/akademik/absensi-pertemuan";

export const Route = createFileRoute('/akademik/jadwal-pelajaran/jadwal-pelajaran-detail')({
    component: () => <Index />
})


const JadwalPelajaranDetail: React.FC = () => {
