...
import useJadwalPelajaranStore from "@/pages/akademik/jadwal-pelajaran/data/useJadwalPelajaranStore.ts";
import JadwalPelajaranEntity from "@/pages/akademik/jadwal-pelajaran/data/jadwal-pelajaran.entity.ts";
import KelasJadwalPelajaranTable
    from "@/pages/akademik/jadwal-pelajaran/components/kelas-jadwal-pelajaran-table.tsx";
